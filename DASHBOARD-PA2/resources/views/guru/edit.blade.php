...
<div class="page-wrapper">
    <div style="max-width: 800px; margin: 0 auto; padding: 0 1.5rem;">
        <div class="premium-header">
            ...
            <p class="breadcrumb-text">Perbarui informasi guru pada form di bawah</p>
        </div>
                ...
                <form action="{{ route('guru.update', $guru->id_guru) }}" method="POST">
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nama_guru') is-invalid @enderror" 
                                   id="nama_guru" name="nama_guru" value="{{ old('nama_guru', $guru->nama_guru) }}" required placeholder="Masukkan nama lengkap guru">
                            @error('nama_guru')
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('no_hp') is-invalid @enderror" 
                                       id="no_hp" name="no_hp" value="{{ old('no_hp', $guru->no_hp) }}" required placeholder="Contoh: 081234567890">
                                @error('no_hp')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control @error('email') is-invalid @enderror" 
                                       id="email" name="email" value="{{ old('email', $guru->email) }}" required placeholder="Contoh: guru@email.com">
                                @error('email')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="action-buttons">
                        <button type="submit" class="btn-premium btn-save">
                            <i class="bi bi-check-circle-fill"></i> Perbarui Guru
                        </button>
