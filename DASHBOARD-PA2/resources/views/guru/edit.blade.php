...
<div class="page-wrapper">
    <div class="container-lg">
        <div class="premium-header">
            <h1><i class="bi bi-pencil-square"></i> Edit Guru</h1>
            <p class="breadcrumb-text">Perbarui informasi guru dengan benar</p>
        </div>
        ...
        <form action="{{ route('guru.update', $guru->id_guru) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <small class="text-muted">Kosongkan jika tidak ingin mengganti foto. JPG, PNG, WEBP, maksimal 4 MB.</small>
                    @error('foto_guru')
                ...
                @if($guru->foto_guru)
                    <div class="form-group">
                        ...
                        <div style="max-width: 180px; border-radius: 1rem; overflow: hidden; border: 1px solid var(--neutral-200); background: var(--neutral-50);">
                            <img src="{{ asset('storage/' . $guru->foto_guru) }}" alt="Foto {{ $guru->nama_guru }}" style="width: 100%; display: block; object-fit: cover;">
                        </div>
                    </div>
                @endif
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('nip_guru') is-invalid @enderror" 
                           id="nip_guru" name="nip_guru" value="{{ old('nip_guru', $guru->nip_guru) }}" 
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control @error('alamat') is-invalid @enderror" 
                              ...
                              placeholder="Masukkan alamat lengkap guru" required>{{ old('alamat', $guru->alamat) }}</textarea>
                    @error('alamat')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('jurusan') is-invalid @enderror" 
                               id="jurusan" name="jurusan" value="{{ old('jurusan', $guru->jurusan) }}" 
                        ...
                        @forelse($kelas as $k)
                            <div class="multiselect-option">
                                <input type="checkbox" name="kelas_ampuan[]" value="{{ $k->id_kelas }}" 
                                       ...
                                       {{ in_array($k->id_kelas, $kelasAmpuanIds ?? []) ? 'checked' : '' }}>
            ...
            <div class="action-buttons">
                <button type="submit" class="btn-premium btn-save">
                    <i class="bi bi-check-circle"></i> Perbarui Guru
                </button>
