                ...
                <tr>
                    <th style="width: 50px;">
                        <div class="select-all-wrapper">
                            <input type="checkbox" id="selectAllAkun" aria-label="Pilih semua akun">
                        </div>
                    </th>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        const selectAllCheckbox = document.getElementById('selectAllAkun');
        const rowCheckboxes = Array.from(document.querySelectorAll('.akun-checkbox'));
        ...
        const syncButtonState = () => {
            ...
            selectedAkunCount.innerHTML = selectedCount > 0
        ...
        bulkDeleteForm.addEventListener('submit', function (event) {
            ...
            if (selectedCount === 0) {
                Swal.fire({
                    icon: 'warning',
                    title: 'Belum ada akun dipilih',
                    text: 'Centang minimal satu akun terlebih dahulu.',
                });
                return;
            }

            Swal.fire({
                title: 'Hapus ' + selectedCount + ' akun?',
