                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('judul') is-invalid @enderror" 
                                   id="judul" name="judul" value="{{ old('judul', $pengumuman->judul) }}" minlength="10" maxlength="150" required placeholder="Masukkan judul pengumuman">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('deskripsi') is-invalid @enderror" 
                                      id="deskripsi" name="deskripsi" minlength="30" maxlength="1500" required placeholder="Tuliskan isi pengumuman dengan detail...">{{ old('deskripsi', $pengumuman->deskripsi) }}</textarea>
